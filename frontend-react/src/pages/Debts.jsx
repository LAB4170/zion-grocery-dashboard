            ...
            {filteredDebts.length === 0 ? (
              ...
              filteredDebts.map(debt => (
                <tr key={debt.id}>
                  ...
                  <td data-label="Phone" style={{ color: 'var(--text-muted)' }}>{debt.customerPhone || 'N/A'}</td>
                  <td data-label="Total Debt" style={{ fontWeight: 600 }}>KSh {Number(debt.amount).toLocaleString()}</td>
                  ...
                  <td data-label="Actions">
                    {debt.balance > 0 && (
                      <button onClick={() => handleOpenPayment(debt)} className="glass" style={{ padding: '8px 12px', borderRadius: '8px', color: 'var(--accent)', fontSize: '12px', fontWeight: 700 }}>
                        Record Payment
                      </button>
                    )}
                  </td>
